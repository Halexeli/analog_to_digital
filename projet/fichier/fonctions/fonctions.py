...
def fonction_sens(position, angle, sens,  Matrice_Horloge,butee):
    if(not butee): 
       return sens
    elem=[0,0]
    if(Matrice_Horloge[position[0]][position[1]][0][0]%360< angle[0]%360):
        if(Matrice_Horloge[position[0]][position[1]][0][0]%360==0):
        ...
        elem[0]=-1
    if(Matrice_Horloge[position[0]][position[1]][0][1]%360< angle[1]%360):
        if(Matrice_Horloge[position[0]][position[1]][0][1]%360==0):
